...
The current version **5.4.1** is available as [NuGet package](http://nuget.org/packages/NHibernate.Logging/).
This version is built against NHibernate 5.4.1 and Common.Logging 3.4.1.
